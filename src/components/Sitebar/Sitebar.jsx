...
import Logo from "../images/RailwayLogo.svg";
import Clouse from "../images/close-512.png"
...
const Sitebar = () => {
    ...
    return (
        <div>
            ...
            <button onClick={toogle} data-drawer-target="separator-sidebar" data-drawer-toggle="separator-sidebar" aria-controls="separator-sidebar" type="button" className="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
            ...
            {open && (
                <>
                    <div className='fixed h-full top-0 h-screenleft-0 z-40 w-64 bg-gray-50 dark:bg-gray-800'>
                        <div className="flex justify-between p-4 align-middle">
                            <div className="logo">
                                <img src={Logo} className=' w-10' alt="" />
                            </div>
                            <div onClick={toogle} className="text-5xl flex p-2 text-white">
                                <img src={Clouse} className='w-10' alt="" />
                            </div>
                        </div>
